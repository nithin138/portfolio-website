        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <motion.div variants={itemVariants}>
              <div className="rounded-2xl p-8 shadow-lg" style={{ border: '1px solid rgba(255,255,255,0.08)' }}>
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  {isSubmitted && (
                    <div className="flex items-center gap-2 p-3 bg-success/10 border border-success/30 rounded-lg text-success text-sm">
                      <CheckCircle size={18} /><span>Thank you! Your message has been sent successfully.</span>
                    </div>
                  )}
                </form>
                <p className="text-xs text-text-muted text-center mt-6">No spam. Your message goes directly to my inbox.</p>
              </div>
            </motion.div>
          </div>
        </motion.div>
